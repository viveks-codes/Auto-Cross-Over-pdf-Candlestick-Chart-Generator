...
def generate_candlestick_chart(email, output_file='candlestick_charts_all_symbols55.pdf'):
    ...
    send_email(attachment_file=output_file, recipient_email=email)
...
def main():
    ...
    # Get email input from query parameter
    ...
    # Input email address
    email_input = email
    # Generate candlestick chart and send email when button is clicked
    generate_candlestick_chart(email_input)
    st.success('Candlestick chart generated and email sent successfully.')
